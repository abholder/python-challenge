...
# get first file
csvpath = os.path.join('/Users/aaronholder/Desktop/UKED201802DATA5-Class-Repository-DATA-master-672eee651885c9eb9b3f52c0fa7d3912e197cf31/03-Python/Homework/PyBoss/raw_data', 'employee_data1.csv')
...
with open(csvpath, 'r') as csvfile:
    ...
    employee_names_joined = list(reader)
    for row in reader:
